...
| `bankCode`             | string | ✅       | Identifier/kode bank (lihat [Banks List](./banks/list-v1)) |
...
| `bankCode` | Required, must exist in [Banks List](./banks/list-v1) |
...
curl -X POST "/api/v1/withdraw" \
  ...
  -d '{
    ...
    "description": "domestic transfer bni 0315747263 009 v1",
...
- Mapping nilai `code` menggunakan referensi Response Code v1 untuk perilaku client yang deterministik.
