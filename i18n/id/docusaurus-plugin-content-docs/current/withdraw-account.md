...
|---|---|
| HTTP Method | `POST` |
| Endpoint | `/api/v1/withdraw-accounts` |
...
| `bankCode` | Required, valid code from [Banks List](./banks/list-v1) |
...
- Selalu resolve `bankCode` dari [Banks List](./banks/list-v1) sebelum mengirim request.
