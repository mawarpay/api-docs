...
| `bankCode`             | string | ✅       | Bank identifier/code (refer to [Banks List](./banks/list-v1)) |
...
- Map `code` values using the v1 Response Code reference for deterministic client behavior.
