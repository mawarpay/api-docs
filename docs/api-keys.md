...
After the API key is saved on your server, open **Webhook Settings** and **IP Whitelist** on the same merchant detail page. See [Webhook Settings](/docs/webhooks-v1) and [IP Whitelist](/docs/settings/ip-whitelist).
